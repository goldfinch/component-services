        ...
        <div class="accordion-item">
          <h2 class="accordion-header">
            <button
              ...
              data-bs-target="#servicesblock-{$Top.ID}-item-{$ID}"
              aria-expanded="false"
              aria-controls="servicesblock-{$Top.ID}-item-{$ID}"
            >
              $Title
            </button>
          </h2>
          <div
            id="servicesblock-{$Top.ID}-item-{$ID}"
            class="accordion-collapse collapse"
            data-bs-parent="#servicesblock-{$Top.ID}"
          >
